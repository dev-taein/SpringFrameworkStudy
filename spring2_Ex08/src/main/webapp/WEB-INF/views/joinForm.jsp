		...
		<form:form commandName="member">
			<table border="1" cellpadding="2" cellspacing="0" width="500">
				...
				<tr>
					...
					<td>
						<form:select path="job">
							...
							<form:options items="${jCodes}" itemLabel="label" itemValue="code" />
						</form:select>
				...
				<tr>
					...
					<td>
						<form:checkboxes items="${hobbyName }" path="hobbys"/>
				...
				<tr>
					<td colspan="2"><form:checkbox path="contractAgreement" label="약관에 동의합니다."></form:checkbox></td>
				</tr>
			</table>
